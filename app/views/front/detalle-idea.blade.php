...
<section id='contend'>
    <div class="detalle-idea">
        ...
        <div id="info-idea">
            <figure>
                <div id="info-idea-fig">
                    <div id="contend-img-user">
            ...
            <ul>
                ...
                <li>
                    <a href="javascript: void(0);"
                       onclick="window.open('http://www.facebook.com/sharer.php?u={{Request::url();}}','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');">
